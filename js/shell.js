...
(function() {
  ...
  const SOCIAL = {
    ...
    whatsapp: 'https://wa.me/595981353110?text=Hola%2C%20estoy%20viendo%20la%20tienda%20de%20MoMar%20y%20quisiera%20consultar.'
  };
      ...
      <footer class="footer">
        <div class="container">
          <div class="footer__grid">
            <div>
              <div class="footer__logo">${LOGO_IMG({ height: 48 })}</div>
    ...
    return `
      <aside class="mobile-menu">
        ...
        <div class="mobile-menu__foot">
          Asunción · Atención por WhatsApp<br>+595 981 353 110
        </div>
      </aside>
    `;
  }
  ...
  function buildWaFloat() {
    return `
      <a href="https://wa.me/595981353110?text=Hola%2C%20estoy%20viendo%20la%20tienda%20de%20MoMar%20y%20quisiera%20consultar." class="wa-float" target="_blank" rel="noopener" aria-label="Consultar por WhatsApp">
